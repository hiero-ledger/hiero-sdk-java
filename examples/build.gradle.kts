...
dependencies.constraints {
    ...
    implementation("com.hedera.hashgraph:sdk:2.76.0")
    implementation("com.hedera.hashgraph:sdk-full:2.76.0")
    ...
    fun runAll() {
        val exampleClasses =
            sources
                ...
                .filter { it != "AccountCreateWithHtsExample" }
                .filter { it != "AccountAliasExample" }
                .toList()
