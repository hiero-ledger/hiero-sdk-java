...
public class EvmHook extends EvmHookSpec {
     ...
     */
    org.hiero.sdk.proto.EvmHook toProtobuf() {
        var specProto = org.hiero.sdk.proto.EvmHookSpec.newBuilder()
                .setContractId(getContractId().toProtobuf())
                .build();
        var builder = org.hiero.sdk.proto.EvmHook.newBuilder().setSpec(specProto);
     ...
     */
    public static EvmHook fromProtobuf(org.hiero.sdk.proto.EvmHook proto) {
