...
public class FeeEstimateQuery {
    ...
    @Nullable
    private org.hiero.sdk.proto.Transaction transaction = null;
     ...
     */
    @Nullable
    public org.hiero.sdk.proto.Transaction getTransaction() {
        return transaction;
    }
     ...
     * @return {@code this}
     */
    public FeeEstimateQuery setTransaction(org.hiero.sdk.proto.Transaction transaction) {
     ...
     * @return {@code this}
     */
    public <T extends org.hiero.sdk.Transaction<T>> FeeEstimateQuery setTransaction(
            org.hiero.sdk.Transaction<T> transaction) {
        Objects.requireNonNull(transaction);
