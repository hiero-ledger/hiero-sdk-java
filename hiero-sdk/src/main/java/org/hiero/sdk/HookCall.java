...
public abstract class HookCall {
     ...
     */
    org.hiero.sdk.proto.HookCall toProtobuf() {
        var builder = org.hiero.sdk.proto.HookCall.newBuilder();
     ...
     */
    static HookCall fromProtobuf(org.hiero.sdk.proto.HookCall proto) {
