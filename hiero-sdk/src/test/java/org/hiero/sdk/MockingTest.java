...
class MockingTest {
    ...
    void testVerifyTransactionFail() throws InvalidProtocolBufferException {
        ...
        var signedTransaction = SignedTransaction.parseFrom(
                org.hiero.sdk.proto.Transaction.parseFrom(serialized).getSignedTransactionBytes());
        org.hiero.sdk.Transaction<?> roundTrip = org.hiero.sdk.Transaction.fromBytes(serialized);
