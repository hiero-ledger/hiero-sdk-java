...
class StatusTest {
    ...
    void newHookAndLambdaStatusesRoundTrip() {
        Object[][] pairs = new Object[][] {
            ...
            {Status.EVM_HOOK_STORAGE_UPDATE_BYTES_TOO_LONG, ResponseCodeEnum.EVM_HOOK_STORAGE_UPDATE_BYTES_TOO_LONG},
            {
                Status.EVM_HOOK_STORAGE_UPDATE_BYTES_MUST_USE_MINIMAL_REPRESENTATION,
            ...
            {Status.EMPTY_EVM_HOOK_STORAGE_UPDATE, ResponseCodeEnum.EMPTY_EVM_HOOK_STORAGE_UPDATE},
