...
class StatusTest {
    ...
    void newHookAndLambdaStatusesRoundTrip() {
        Object[][] pairs = new Object[][] {
            { Status.INVALID_SERIALIZED_TX_MESSAGE_HASH_ALGORITHM, ResponseCodeEnum.INVALID_SERIALIZED_TX_MESSAGE_HASH_ALGORITHM },
            ...
            { Status.LAMBDA_STORAGE_UPDATE_BYTES_MUST_USE_MINIMAL_REPRESENTATION, ResponseCodeEnum.LAMBDA_STORAGE_UPDATE_BYTES_MUST_USE_MINIMAL_REPRESENTATION },
            ...
            { Status.HOOK_DELETION_REQUIRES_ZERO_STORAGE_SLOTS, ResponseCodeEnum.HOOK_DELETION_REQUIRES_ZERO_STORAGE_SLOTS },
