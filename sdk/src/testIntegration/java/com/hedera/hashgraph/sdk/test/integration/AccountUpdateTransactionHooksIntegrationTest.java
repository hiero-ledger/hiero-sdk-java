...
class AccountUpdateTransactionHooksIntegrationTest {
    ...
    void accountUpdateWithExistingHookIdFails() throws Exception {
        try (var testEnv = new IntegrationTestEnv(1)) {
            ...
            var evmHookSpec1 = new EvmHookSpec(hookContractId1);
            var lambdaHook1 = new LambdaEvmHook(evmHookSpec1);
            ...
            var evmHookSpec2 = new EvmHookSpec(hookContractId2);
            var lambdaHook2 = new LambdaEvmHook(evmHookSpec2);
